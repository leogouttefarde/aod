...
On rappelle que l'on note $n_1$ ($n_2$) et $c_1$ ($c_2$) le nombre de lignes et caractères du fichier source (fichier cible).
...
Nous avons créé nous même quelques patchs pour tester d'autres valeurs de $n_1$ et compléter le graphe.
